...
public class CaseSceneManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource sfxGeneralSource;
    [SerializeField] private AudioSource sfxRatingSource;
    [SerializeField] private AudioSource sfxAudienceSource;
    ...
    private void ProcessTags(List<string> currentTags)
    {
        foreach (string tag in currentTags)
        {
            ...
            else if (trimmedTag.StartsWith("SFX_"))
            {
                ...
                AudioSource src = sfxGeneralSource;
                if (trimmedTag.Contains("RATING")) src = sfxRatingSource;
                else if (trimmedTag.Contains("AUDIENCE")) src = sfxAudienceSource;
